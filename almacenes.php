    ...
    <section class="hero hero-page gray-bg padding-small">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="CTAs d-flex justify-content-between flex-column flex-lg-row">
              <button type="submit" data-toggle="modal" data-target="#nuevo_almacen" class="btn btn-template">A&ntildeadir nuevo almac&eacuten<i class="fa fa-plus"></i></button>
            </div>
          </div>
        </div><br>
      </div>
...
<div id="modificar_contra" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
      ...
      <!--MODAL MODIFICAR ALMACEN-->
        <div id="modal_modificar" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
          <div role="document" class="modal-dialog">
            <div class="modal-content">
              <div class="ribbon-primary text-uppercase">Modificar Almac&eacuten</div>
              <div class="modal-body">
                <div class="align-items-center">
                  <form id="form_modificar" method='post'>
                    <div class="details">
                      <div class="form-group">
                        ...
                        Localización:
                        <input type="text" id="loc_mod" name="loc_mod" value="" required class="form-control input-sm form-control-sm">
                      </div>
                      <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
                      <input type="button" name="delete_boton" id="delete_boton" value="Borrar Almacén">
    ...
    <!--MODAL AÑADIR ALMACEN-->
     <div id="nuevo_almacen" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="ribbon-primary text-uppercase">Crear almac&eacuten</div>
            <div class="modal-body"> 
              <div class="align-items-center">
                <form id="form_anadir"  METHOD="POST">
                  <div class="details">
                    <div class="form-group">
                      ...
                      Localización:<br>
                      <input type="text" id="loc" name="loc" value="" required class="form-control input-sm form-control-sm">
                    </div>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
    ...
    <script src="js/tabla_almacen.js"></script>
