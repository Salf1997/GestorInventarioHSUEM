  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-md-3"></div>
          <div class="col-md-4">
              <div class="CTAs d-flex justify-content-between flex-column flex-lg-row"><a href="" data-toggle="modal" data-target="#nuevo_informe" class="btn btn-template">Crear informe<i class="fa fa-plus"></i></a></div>
          </div>
        </div>
            <br>
      </div>
                ...
                <table id="tabla"  class="table-responsive">
                  <thead>
                    <tr>
                      ...
                      <th>&Uacuteltima Modificaci&oacuten</th>
                      <th>Modificar</th>
                    </tr>
                  </thead>
...
<div id="modificar_contra" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
   ...
   <div id="nuevo_informe" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
    ...
    <script src="js/tabla_informes.js"></script>
