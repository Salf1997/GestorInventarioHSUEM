<?php
  ...
  if (!isset($_SESSION['rol'])){
    ...
    require('php/db.php');
    $aula=$_GET['idAula'];
    $sel_query="SELECT `nombre_Aula` FROM `aula` WHERE `aula`.`idAula`='$aula' LIMIT 1";
    $result= mysqli_query($con,$sel_query);
    $row = mysqli_fetch_assoc($result);
    $_SESSION['nombreAula'] = $row['nombre_Aula'];
    mysqli_close($con);
?>
<!DOCTYPE html>
<html lang="esp">
        ...
        <div class="container">
          <div class="row d-flex">
            <div class="col-lg-9 order-2 order-lg-1">
              <h1 id="nombreAula" valor="<?php echo $aula; ?>">
                  <?php echo $_SESSION['nombreAula']; ?>
              </h1>
            </div>
            <div class="col-lg-3 text-right order-1 order-lg-2">
              <ul class="breadcrumb justify-content-lg-end">
                <li class="breadcrumb-item"><a href="aulas.php">
                <?php echo $_SESSION['nombreAula']; ?>
                </a></li>
      ...
      <div class="container">
          ...
          <div class="col-md-3">
            <div class="CTAs d-flex justify-content-between flex-column flex-lg-row">
              ...
              <div class="col-md-4">
                  <div class="CTAs d-flex justify-content-between flex-column flex-lg-row">
                    <a id="boton_nuevo" href="" data-toggle="modal" data-target="#nuevo_prod" class="btn btn-template">A&ntildeadir nuevo producto a <?php echo $_SESSION['nombreAula']; ?> <i class="fa fa-plus"></i></a>
                  </div>
              </div>
            </div>
            <br>
          ...
          <div class="container">
            <div class="row">
                <div class="col-md-1"></div>
                <div id="<?php echo $aula; ?>" class="col-md-11">
...
<div id="modificar_contra" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
      ...
      <!--MODIFICAR PRODUCTOS AULA-->
      <div id="modal_modificar" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="ribbon-primary text-uppercase">Modificar Producto en <?php echo $_SESSION['nombreAula']; ?></div>
            <div class="modal-body">
              <div class="align-items-center">
                <form id="form_modificar" method='post'>
                  <div class="details">
                    <div class="form-group">
                      <input type="text" name="idProd" id="identificador_mod" required hidden>
                      Producto:<br>
                      <input type="text" name="producto" id="producto_mod" readonly class="form-control input-sm form-control-sm"><br>
                      <div class="row">
                        <div class="col-md-5">
                          Stock disponible:
                          <p id="cantidad_mod"></p>
                      ...
                      <p id="almacen_mod"></p>
                      Cantidad:<br>
                      <input type="number" name="stock" id="stock_mod" class="form-control input-sm form-control-sm">
                    </div>
                    <input type="text" name="idAula" id="idAula_mod" required hidden>
                    <input type="text" name="idBalda" id="idBalda_mod" required hidden>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
    ...
    <!--AÑADIR PRODUCTO AULA-->
     <div id="nuevo_prod" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="ribbon-primary text-uppercase">A&ntildeadir Producto a <?php echo $_SESSION['nombreAula']; ?></div>
            <div class="modal-body"> 
              <div class="align-items-center">
                <form id="form_anadir"  METHOD="POST">
                  <div class="details">
                    <div class="form-group">
                      <label for="titulacion_curso" class="form-label">Producto:</label><br>
                      <select style="width: 300px" name="producto" id="select_form">
                    ...
                    <p id="almacen_an"></p>
                    Cantidad:<br>
                    <input type="text" id="stock_an" name="stock" value="" required class="form-control input-sm form-control-sm">
                    <input type="text" name="aula" id="aula" value="<?php echo $aula ?>" required hidden> <br>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
    ...
    <script src="js/tabla_productos_aula.js"></script>
