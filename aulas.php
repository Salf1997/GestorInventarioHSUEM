        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="CTAs d-flex justify-content-between flex-column flex-lg-row">
              ...
              <div class="col-md-4">
                  <div class="CTAs d-flex justify-content-between flex-column flex-lg-row"><a href="" data-toggle="modal" data-target="#nueva_aula" class="btn btn-template">A&ntildeadir nueva Sala <i class="fa fa-plus"></i></a></div>
              </div>
            </div>
            <br>
          </div>
...
<div id="modificar_contra" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
      ...
      <!--MODAL AÑADIR SALA--> 
        <div id="nueva_aula" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="ribbon-primary text-uppercase">A&ntildeadir Sala</div>
            <div class="modal-body"> 
              <div class="align-items-center">
                <form id="form_anadir">
                  <div class="form-group">
                    Nombre:<br>
                    <input type="text" name="nombre" class="form-control input-sm form-control-sm" id="nombre_an" value="" required><br>
                    Tipo:<br>
                    <input type="text" name="tipo" class="form-control input-sm form-control-sm" id="tipo_an" value=""><br><br>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
                    <input type="button" name="mod_boton" id="an_boton" value="Añadir">                  
                  </div>
                </form>
              </div>
            </div>
      ...
      <!--MODAL MODIFICAR SALA-->
      <div id="modal_modificar" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="ribbon-primary text-uppercase">Modificar Sala</div>
            <div class="modal-body">
              <div class="align-items-center">
                <form id="form_modificar">
                  <div class="form-group">
                    <input hidden type="text" name="id_mod" id="id_mod" readonly><br>
                    Nombre:<br>
                    <input type="text" name="nombre_mod" class="form-control input-sm form-control-sm" id="nombre_mod"><br>
                    Tipo:<br>
                    <input type="text" name="tipo_mod" class="form-control input-sm form-control-sm" id="tipo_mod"><br>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
    ...
    <script src="js/tabla_aula.js"></script>
