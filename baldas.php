...
if (!isset($_SESSION['rol'])){
  ...
  require('php/db.php');
    $id=$_GET['idAlmacen'];
    $sel_query="SELECT `nombre_Almacen` FROM `almacen` WHERE `almacen`.`idAlmacen`='$id' LIMIT 1";
    $result= mysqli_query($con,$sel_query);
    $row = mysqli_fetch_assoc($result);
    $_SESSION['nombreAlmacen'] =$row["nombre_Almacen"];
    mysqli_close($con);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container">
              <div class="row d-flex">
                <div class="col-lg-9 order-2 order-lg-1">
                  <h1 id="id_Almacen" valor="<?php echo $id; ?>"><?php echo $_SESSION['nombreAlmacen']; ?> - Baldas</h1>
                </div>
                <div class="col-lg-3 text-right order-1 order-lg-2">
                  <ul class="breadcrumb justify-content-lg-end">
                    <li class="breadcrumb-item"><a href="inicio.php">Inicio</a></li>
                    <li class="breadcrumb-item"><a href="almacenes.php"><?php echo $_SESSION['nombreAlmacen']; ?></a></li>
                    <li class="breadcrumb-item active">Baldas</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <section>
        <div class="container">
          ...
          <div class="col-md-3">
            ...
            <div class="col-md-4">
              <div class="CTAs d-flex justify-content-between flex-column flex-lg-row"><a href="" data-toggle="modal" data-target="#nueva_balda" class="btn btn-template">A&ntildeadir nueva balda<i class="fa fa-plus"></i></a></div>
            </div>
          </div><br>
        </div>
        <div class="container">
...
<div id="modificar_contra" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
      ...
      <!--MODAL MODIFICAR BALDA-->
        <div id="modal_modificar" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
          <div role="document" class="modal-dialog">
            <div class="modal-content">
              <div class="ribbon-primary text-uppercase">Modificar Balda</div>
              <div class="modal-body">
                <div class="align-items-center">
                  <form id="form_modificar" method='post'>
                      <div class="details">
                        <div class="form-group">
                          <input type="text" name="identificador_mod" id="identificador_mod" value="" required hidden >
                          Nombre:<br>
                          <input type="text" id="nombre_mod" name="nombre_mod" value="" required class="form-control input-sm form-control-sm"><br>
                          Localización:
                          <input type="text" value="<?php echo $_SESSION['nombreAlmacen']; ?>" required readonly class="form-control input-sm form-control-sm">
                        </div>
                      <input type="button" name="delete_boton" id="delete_boton" value="Borrar">
                      <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
    ...
    <!--MODAL AÑADIR BALDA-->
     <div id="nueva_balda" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="ribbon-primary text-uppercase">Crear Balda</div>
            <div class="modal-body"> 
              <div class="align-items-center">
                <form id="form_anadir"  METHOD="POST">
                  <div class="details">
                    <div class="form-group">
                      ...
                      Localización:<br>
                      <input type="text" id="loc" name="loc" value="<?php echo $_SESSION['nombreAlmacen']; ?>" required readonly class="form-control input-sm form-control-sm">
                    </div>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
    ...
    <script src="js/tabla_balda.js"></script>
