...
<html lang="esp">
  ...
  <body>
        ...
        <div class="container">
          <div class="row d-flex">
            <div class="col-lg-9 order-2 order-lg-1">
              <h1>Productos en alerta</h1>
            </div>
            <div class="col-lg-3 text-right order-1 order-lg-2">
              <ul class="breadcrumb justify-content-lg-end">
                <li class="breadcrumb-item"><a href="inicio.php">Inicio</a></li>
                <li class="breadcrumb-item active">Productos en alerta</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <br>
      <div class="container">
            <div class="row">
                ...
                <div class="col-md-2">
                    <p><span class="red">1</span>Productos a punto de agotarse</p>
                </div>
                <div class="col-md-2">
                    <p><span class="yellow">2</span>Alerta de stock bajo</p>
                </div>
                <div class="col-md-3">
              ...
              <div class="modal-body">
                <div class="align-items-center">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="descripcion_mod" class="form-control input-sm form-control-sm" id="descripcion_mod" rows="1"></textarea>
                    </div>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
    ...
    <script src="js/tabla_alertas.js"></script>
