<?php
  ...
  if (!isset($_SESSION['rol'])){
    ...
    $sel_query="SELECT `nombre_Balda` FROM `balda` WHERE `balda`.`idBalda`='$balda' LIMIT 1";
    $result= mysqli_query($con,$sel_query);
    $row = mysqli_fetch_assoc($result);
    $_SESSION['nombreBalda'] =$row["nombre_Balda"];

    $sel_query2="SELECT `nombre_Almacen` FROM `almacen` WHERE `almacen`.`idAlmacen`='$idAlmacen' LIMIT 1";
    $result2= mysqli_query($con,$sel_query2);
    $row2 = mysqli_fetch_assoc($result2);
    $_SESSION['nombreAlmacen'] =$row2["nombre_Almacen"];
...
<html lang="esp">
        ...
        <div class="container">
          <div class="row d-flex">
            <div class="col-lg-9 order-2 order-lg-1">
              <h1 id="nombreBalda" valor="<?php echo $balda; ?>">
                  <?php echo $_SESSION['nombreBalda']; ?>
              </h1>
            </div>
            <div class="col-lg-3 text-right order-1 order-lg-2">
              <ul class="breadcrumb justify-content-lg-end">
                <li class="breadcrumb-item"><a href="inicio.php">Inicio</a></li>
                <li class="breadcrumb-item"><a href="almacenes.php"><?php echo $_SESSION['nombreAlmacen']; ?></a></li>
                <li class="breadcrumb-item"><a href="baldas.php?idAlmacen=<?php echo $idAlmacen; ?>"><?php echo $_SESSION['nombreBalda']; ?></a></li>
      ...
      <div class="container">
          ...
          <div class="col-md-3">
            <div class="CTAs d-flex justify-content-between flex-column flex-lg-row">
              ...
              <div class="col-md-4">
                  <div class="CTAs d-flex justify-content-between flex-column flex-lg-row"><a id="btn_anadir" data-toggle="modal" data-target="#nuevo_prod" class="btn btn-template">A&ntildeadir nuevo producto a <?php echo $_SESSION['nombreBalda']; ?> <i class="fa fa-plus"></i></a></div>
              </div>
            </div>
            <br>
          </div>
          <div class="container">
            <div class="row">
                <div class="col-md-1"></div>
                <div id="<?php echo $balda; ?>" class="col-md-11">
  ...
  <div id="modificar_contra" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
    ...
    <div id="modal_modificar" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="ribbon-primary text-uppercase">Modificar Producto en <?php echo $_SESSION['nombreBalda']; ?></div>
            <div class="modal-body">
              <div class="align-items-center">
                <form id="form_modificar" method='post'>
                  <div class="details">
                    <div class="form-group">
                      ...
                      Producto:<br>
                      <input type="text" name="producto_mod" id="producto_mod" readonly class="form-control input-sm form-control-sm"><br>
                      Descripci&oacuten:<br>
                      <input type="text" name="descripcion_mod" id="descripcion_mod" readonly class="form-control input-sm form-control-sm"><br>
                      <div class="row">
                        <div class="col-md-5">
                          Stock actual:
                          <p id="cantidad_actual"></p>
                        </div>
                        <div class="col-md-2"></div>
                        <div class="col-md-5">
                          Stock disponible:
                          <p id="cantidad_disponible"></p>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-12">
                      ...
                      Cantidad:<br>
                      <input type="number" name="stock_mod" id="stock_mod" class="form-control input-sm form-control-sm">
                    </div>
                    <input type="text" name="idBalda_mod" value="<?php echo $balda; ?>" required hidden>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
                    <input type="button" name="mod_boton" id="mod_boton" value="Modificar"></div>
                </form>
              </div>
            </div>
          </div>
    ...
    <div id="nuevo_prod" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="ribbon-primary text-uppercase">A&ntildeadir Producto a <?php echo $_SESSION['nombreBalda']; ?> en  <?php echo $_SESSION['nombreAlmacen']; ?></div>
            <div class="modal-body"> 
              <div class="align-items-center">
                <form id="form_anadir"  METHOD="POST">
                  <div class="details">
                    <div class="form-group">
                      Producto:<br>
                      <select name="producto_an" id="select_form" form="form_anadir" class="bootstrap-select" style="width: 300px"></select><br>
                      Tipo:
                      <p id="descripcion"></p>
                      <div class="row">
                        <div class="col-md-5">
                      ...
                      Cantidad:<br>
                      <input type="text" id="stock_an" name="stock_an" value="" required class="form-control input-sm form-control-sm">
                      <input type="text" name="idBalda_an" value="<?php echo $balda ?>" required hidden>
                    </div>
                    <input type="button" name="salir_modal" data-dismiss="modal" value="Cancelar">
    ...
    <script src="js/tabla_productos_balda.js"></script>
